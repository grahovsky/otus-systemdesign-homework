...
8 сервисов — см. [arc42 §4](arc42/04-solution-strategy.md#42-декомпозиция-8-сервисов) и C2.
...
Микс с обоснованием: [§4.3](arc42/04-solution-strategy.md#43-протоколы-микс), [ADR-0001](arc42/adr/0001-protocol-mix.md).
