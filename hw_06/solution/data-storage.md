...
|---|---|---|---|---|
| `app_id` | 2 000 приложений разного размера; равномерность не из hash, а из биннинга по объёму | funnel / retention / сегменты / DAU-MAU всегда с одним `appId` в пути → один шард, без scatter-gather | самое нагруженное приложение (2 % потока, ~36 ГБ сжатого ряда / 90 дней на диске) целиком на одном шарде | **берём** |
